...
contains
  ...
  subroutine test_init_field_grid_logical( test_name_parent)
    ...
    call unit_test( (&
      ...
      field_grid_2D%is_Arakawa_grid( Arakawa_grid%a()) .and. &
      lb1_a == grid%n1 .and. &
      ub1_a == grid%n2 .and. &
      lb1_f == grid%n1 .and. &
      ub1_f == grid%n2 .and. &
    ...
    call unit_test( (&
      ...
      field_grid_3D_zeta%is_third_dimension( third_dimension%ice_zeta( nz)) .and. &
      field_grid_3D_zeta%is_Arakawa_grid( Arakawa_grid%a()) .and. &
      lb1_a == grid%n1 .and. &
      ub1_a == grid%n2 .and. &
      lb1_f == grid%n1 .and. &
      ub1_f == grid%n2 .and. &
    ...
    call unit_test( (&
      ...
      field_grid_3D_month%is_third_dimension( third_dimension%month()) .and. &
      field_grid_3D_month%is_Arakawa_grid( Arakawa_grid%a()) .and. &
      lb1_a == grid%n1 .and. &
      ub1_a == grid%n2 .and. &
      lb1_f == grid%n1 .and. &
      ub1_f == grid%n2 .and. &
    ...
    call unit_test( (&
      ...
      field_grid_3D_ocean%is_third_dimension( third_dimension%ocean_depth( nz)) .and. &
      field_grid_3D_ocean%is_Arakawa_grid( Arakawa_grid%a()) .and. &
      lb1_a == grid%n1 .and. &
      ub1_a == grid%n2 .and. &
      lb1_f == grid%n1 .and. &
      ub1_f == grid%n2 .and. &
  ...
  subroutine test_init_field_mesh_logical_a( test_name_parent, mesh)
    ...
    call unit_test( (&
      ...
      field_mesh_2D%is_Arakawa_grid( Arakawa_grid%a()) .and. &
      lb1_a == mesh%vi1 .and. &
      ub1_a == mesh%vi2 .and. &
      lb1_f == mesh%vi1 .and. &
      ub1_f == mesh%vi2 .and. &
    ...
    call unit_test( (&
      ...
      field_mesh_3D_zeta%is_third_dimension( third_dimension%ice_zeta( nz)) .and. &
      field_mesh_3D_zeta%is_Arakawa_grid( Arakawa_grid%a()) .and. &
      lb1_a == mesh%vi1 .and. &
      ub1_a == mesh%vi2 .and. &
      lb1_f == mesh%vi1 .and. &
      ub1_f == mesh%vi2 .and. &
    ...
    call unit_test( (&
      ...
      field_mesh_3D_month%is_third_dimension( third_dimension%month()) .and. &
      field_mesh_3D_month%is_Arakawa_grid( Arakawa_grid%a()) .and. &
      lb1_a == mesh%vi1 .and. &
      ub1_a == mesh%vi2 .and. &
      lb1_f == mesh%vi1 .and. &
      ub1_f == mesh%vi2 .and. &
    ...
    call unit_test( (&
      ...
      field_mesh_3D_ocean%is_third_dimension( third_dimension%ocean_depth( nz)) .and. &
      field_mesh_3D_ocean%is_Arakawa_grid( Arakawa_grid%a()) .and. &
      lb1_a == mesh%vi1 .and. &
      ub1_a == mesh%vi2 .and. &
      lb1_f == mesh%vi1 .and. &
      ub1_f == mesh%vi2 .and. &
  ...
  subroutine test_init_field_mesh_logical_b( test_name_parent, mesh)
    ...
    call unit_test( (&
      ...
      field_mesh_2D%units     == units .and. &
      field_mesh_2D%is_parent( mesh) .and. &
      field_mesh_2D%is_Arakawa_grid( Arakawa_grid%b()) .and. &
      lb1_a == mesh%ti1 .and. &
      ub1_a == mesh%ti2 .and. &
      lb1_f == mesh%ti1 .and. &
      ub1_f == mesh%ti2 .and. &
    ...
    call unit_test( (&
      ...
      field_mesh_3D_zeta%is_parent( mesh) .and. &
      field_mesh_3D_zeta%is_third_dimension( third_dimension%ice_zeta( nz)) .and. &
      field_mesh_3D_zeta%is_Arakawa_grid( Arakawa_grid%b()) .and. &
      lb1_a == mesh%ti1 .and. &
      ub1_a == mesh%ti2 .and. &
      lb1_f == mesh%ti1 .and. &
      ub1_f == mesh%ti2 .and. &
    ...
    call unit_test( (&
      ...
      field_mesh_3D_month%is_parent( mesh) .and. &
      field_mesh_3D_month%is_third_dimension( third_dimension%month()) .and. &
      field_mesh_3D_month%is_Arakawa_grid( Arakawa_grid%b()) .and. &
      lb1_a == mesh%ti1 .and. &
      ub1_a == mesh%ti2 .and. &
      lb1_f == mesh%ti1 .and. &
      ub1_f == mesh%ti2 .and. &
    ...
    call unit_test( (&
      ...
      field_mesh_3D_ocean%is_parent( mesh) .and. &
      field_mesh_3D_ocean%is_third_dimension( third_dimension%ocean_depth( nz)) .and. &
      field_mesh_3D_ocean%is_Arakawa_grid( Arakawa_grid%b()) .and. &
      lb1_a == mesh%ti1 .and. &
      ub1_a == mesh%ti2 .and. &
      lb1_f == mesh%ti1 .and. &
      ub1_f == mesh%ti2 .and. &
  ...
  subroutine test_init_field_mesh_logical_c( test_name_parent, mesh)
    ...
    call unit_test( (&
      ...
      field_mesh_2D%units     == units .and. &
      field_mesh_2D%is_parent( mesh) .and. &
      field_mesh_2D%is_Arakawa_grid( Arakawa_grid%c()) .and. &
      lb1_a == mesh%ei1 .and. &
      ub1_a == mesh%ei2 .and. &
      lb1_f == mesh%ei1 .and. &
      ub1_f == mesh%ei2 .and. &
    ...
    call unit_test( (&
      ...
      field_mesh_3D_zeta%is_parent( mesh) .and. &
      field_mesh_3D_zeta%is_third_dimension( third_dimension%ice_zeta( nz)) .and. &
      field_mesh_3D_zeta%is_Arakawa_grid( Arakawa_grid%c()) .and. &
      lb1_a == mesh%ei1 .and. &
      ub1_a == mesh%ei2 .and. &
      lb1_f == mesh%ei1 .and. &
      ub1_f == mesh%ei2 .and. &
    ...
    call unit_test( (&
      ...
      field_mesh_3D_month%is_parent( mesh) .and. &
      field_mesh_3D_month%is_third_dimension( third_dimension%month()) .and. &
      field_mesh_3D_month%is_Arakawa_grid( Arakawa_grid%c()) .and. &
      lb1_a == mesh%ei1 .and. &
      ub1_a == mesh%ei2 .and. &
      lb1_f == mesh%ei1 .and. &
      ub1_f == mesh%ei2 .and. &
    ...
    call unit_test( (&
      ...
      field_mesh_3D_ocean%is_parent( mesh) .and. &
      field_mesh_3D_ocean%is_third_dimension( third_dimension%ocean_depth( nz)) .and. &
      field_mesh_3D_ocean%is_Arakawa_grid( Arakawa_grid%c()) .and. &
      lb1_a == mesh%ei1 .and. &
      ub1_a == mesh%ei2 .and. &
      lb1_f == mesh%ei1 .and. &
      ub1_f == mesh%ei2 .and. &
