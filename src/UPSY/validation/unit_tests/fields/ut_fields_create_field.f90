...
contains
  ...
  subroutine test_create_field_grid_logical( test_name_parent, coll, grid)
    ...
    call unit_test( (&
      ...
      lb1_f == grid%n1 .and. &
      ub1_f == grid%n2 .and. &
      d_grid_2D( grid%n1+1) .eqv. test_val), &
      trim( test_name) // '_2D')
    ...
    call unit_test( (&
      ...
      lb2_f == 1  .and. &
      ub2_f == nz .and. &
      d_grid_3D_zeta( grid%n1+1, 3) .eqv. test_val), &
    ...
    call unit_test( (&
      ...
      lb2_f == 1  .and. &
      ub2_f == 12 .and. &
      d_grid_3D_month( grid%n1+1, 3) .eqv. test_val), &
    ...
    call unit_test( (&
      ...
      lb2_f == 1  .and. &
      ub2_f == nz .and. &
      d_grid_3D_ocean( grid%n1+1, 3) .eqv. test_val), &
  ...
  subroutine test_create_field_mesh_logical_a( test_name_parent, coll, mesh)
    ...
    call unit_test( (&
      ...
      lb1_f == mesh%vi1 .and. &
      ub1_f == mesh%vi2 .and. &
      d_mesh_2D( mesh%vi1+1) .eqv. test_val), &
      trim( test_name) // '_2D')
    ...
    call unit_test( (&
      ...
      lb2_f == 1  .and. &
      ub2_f == nz .and. &
      d_mesh_3D_zeta( mesh%vi1+1, 3) .eqv. test_val), &
      trim( test_name) // '_3D_zeta')
    ...
    call unit_test( (&
      ...
      lb2_f == 1  .and. &
      ub2_f == 12 .and. &
      d_mesh_3D_month( mesh%vi1+1, 3) .eqv. test_val), &
      trim( test_name) // '_3D_month')
    ...
    call unit_test( (&
      ...
      lb2_f == 1  .and. &
      ub2_f == nz .and. &
      d_mesh_3D_ocean( mesh%vi1+1, 3) .eqv. test_val), &
      trim( test_name) // '_3D_ocean')
  ...
  subroutine test_create_field_mesh_logical_b( test_name_parent, coll, mesh)
    ...
    call unit_test( (&
      ...
      lb1_f == mesh%ti1 .and. &
      ub1_f == mesh%ti2 .and. &
      d_mesh_2D( mesh%ti1+1) .eqv. test_val), &
      trim( test_name) // '_2D')
    ...
    call unit_test( (&
      ...
      lb2_f == 1  .and. &
      ub2_f == nz .and. &
      d_mesh_3D_zeta( mesh%ti1+1, 3) .eqv. test_val), &
      trim( test_name) // '_3D_zeta')
    ...
    call unit_test( (&
      ...
      lb2_f == 1  .and. &
      ub2_f == 12 .and. &
      d_mesh_3D_month( mesh%ti1+1, 3) .eqv. test_val), &
      trim( test_name) // '_3D_month')
    ...
    call unit_test( (&
      ...
      lb2_f == 1  .and. &
      ub2_f == nz .and. &
      d_mesh_3D_ocean( mesh%ti1+1, 3) .eqv. test_val), &
      trim( test_name) // '_3D_ocean')
  ...
  subroutine test_create_field_mesh_logical_c( test_name_parent, coll, mesh)
    ...
    call unit_test( (&
      ...
      lb1_f == mesh%ei1 .and. &
      ub1_f == mesh%ei2 .and. &
      d_mesh_2D( mesh%ei1+1) .eqv. test_val), &
      trim( test_name) // '_2D')
    ...
    call unit_test( (&
      ...
      lb2_f == 1  .and. &
      ub2_f == nz .and. &
      d_mesh_3D_zeta( mesh%ei1+1, 3) .eqv. test_val), &
      trim( test_name) // '_3D_zeta')
    ...
    call unit_test( (&
      ...
      lb2_f == 1  .and. &
      ub2_f == 12 .and. &
      d_mesh_3D_month( mesh%ei1+1, 3) .eqv. test_val), &
      trim( test_name) // '_3D_month')
    ...
    call unit_test( (&
      ...
      lb2_f == 1  .and. &
      ub2_f == nz .and. &
      d_mesh_3D_ocean( mesh%ei1+1, 3) .eqv. test_val), &
      trim( test_name) // '_3D_ocean')
