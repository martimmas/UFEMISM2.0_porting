module netcdf_write_var_primary
  ...
  interface write_var_primary
    procedure write_var_primary_logical_0D
    procedure write_var_primary_logical_1D
    procedure write_var_primary_logical_2D
    procedure write_var_primary_logical_3D
    procedure write_var_primary_logical_4D
...
! ===================
  ...
  subroutine write_var_primary_logical_0D( filename, ncid, id_var, d)
    ...
    ! Local variables:
    character(len=1024), parameter :: routine_name = 'write_var_primary_logical_0D'
    ...
    if (par%primary) then
      d_int = logical2int(d)
      call handle_netcdf_error( NF90_PUT_VAR( ncid, id_var, d_int), &
  ...
  end subroutine write_var_primary_logical_0D

  subroutine write_var_primary_logical_1D(  filename, ncid, id_var, d, start, count)
    ! Write data to a NetCDF file
    ...
    ! Local variables:
    character(len=1024), parameter                     :: routine_name = 'write_var_primary_logical_1D'
    character(len=1024)                                :: var_name
    integer                                            :: var_type
    integer                                            :: ndims_of_var
    ...
    if (par%primary) then
      d_int = logical2int(d)
      call handle_netcdf_error( NF90_PUT_VAR( ncid, id_var, d_int, start_applied, count_applied), &
        filename = filename, dimvarname = var_name)
    end if
  ...
  end subroutine write_var_primary_logical_1D

  subroutine write_var_primary_logical_2D( filename, ncid, id_var, d, start, count)
    ! Write data to a NetCDF file
    ...
    ! Local variables:
    character(len=1024), parameter          :: routine_name = 'write_var_primary_logical_2D'
    character(len=1024)                     :: var_name
    integer                                 :: var_type
    integer                                 :: ndims_of_var
    integer,  dimension( NF90_MAX_VAR_DIMS) :: dims_of_var
  ...
  end subroutine write_var_primary_logical_2D

  subroutine write_var_primary_logical_3D( filename, ncid, id_var, d, start, count)
    ! Write data to a NetCDF file
    ...
    ! Local variables:
    character(len=1024), parameter          :: routine_name = 'write_var_primary_logical_3D'
    character(len=1024)                     :: var_name
    integer                                 :: var_type
    integer                                 :: ndims_of_var
    integer,  dimension( NF90_MAX_VAR_DIMS) :: dims_of_var
  ...
  end subroutine write_var_primary_logical_3D

  subroutine write_var_primary_logical_4D( filename, ncid, id_var, d, start, count)
    ! Write data to a NetCDF file
    ...
    ! Local variables:
    character(len=1024), parameter          :: routine_name = 'write_var_primary_logical_4D'
    character(len=1024)                     :: var_name
    integer                                 :: var_type
    integer                                 :: ndims_of_var
    integer,  dimension( NF90_MAX_VAR_DIMS) :: dims_of_var
  ...
  end subroutine write_var_primary_logical_4D
...
elemental integer function logical2int( d)
  logical, intent(in) :: d
  if (d) then
    logical2int = 1
  else
