...
contains
  ...
  subroutine add_field_mesh_dp_2D( filename, ncid, var_name, long_name, units, precision)
    !< Add a 2-D variable to an existing NetCDF file with a mesh
    ...
    ! Create variable
    call create_variable( filename, ncid, var_name, parse_netcdf_precision( precision), (/ id_dim_vi, id_dim_time /), id_var)
  ...
  subroutine add_field_mesh_dp_2D_b( filename, ncid, var_name, long_name, units, precision)
    !< Add a 2-D variable to an existing NetCDF file with a mesh
    ...
    ! Create variable
    call create_variable( filename, ncid, var_name, parse_netcdf_precision( precision), (/ id_dim_ti, id_dim_time /), id_var)
  ...
  subroutine add_field_mesh_dp_2D_monthly( filename, ncid, var_name, long_name, units, precision)
    ...
    ! Create variable
    call create_variable( filename, ncid, var_name, parse_netcdf_precision( precision), (/ id_dim_vi, id_dim_month, id_dim_time /), id_var)
  ...
  subroutine add_field_mesh_dp_3D( filename, ncid, var_name, long_name, units, precision)
    ...
    ! Create variable
    call create_variable( filename, ncid, var_name, parse_netcdf_precision( precision), (/ id_dim_vi, id_dim_zeta, id_dim_time /), id_var)
  ...
  subroutine add_field_mesh_dp_3D_b( filename, ncid, var_name, long_name, units, precision)
    !< Add a 3-D variable to an existing NetCDF file with a mesh
    ...
    ! Create variable
    call create_variable( filename, ncid, var_name, parse_netcdf_precision( precision), (/ id_dim_ti, id_dim_zeta, id_dim_time /), id_var)
  ...
  subroutine add_field_mesh_dp_3D_ocean( filename, ncid, var_name, long_name, units, precision)
    !< Add a 3-D variable to an existing NetCDF file with a mesh
    ...
    ! Create variable
    call create_variable( filename, ncid, var_name, parse_netcdf_precision( precision), (/ id_dim_vi, id_dim_depth, id_dim_time /), id_var)
  ...
  subroutine add_field_mesh_int_2D_notime( filename, ncid, var_name, long_name, units, precision)
    !< Add a 2-D variable to an existing NetCDF file with a mesh
  ...
  subroutine add_field_mesh_int_2D_b_notime( filename, ncid, var_name, long_name, units, precision)
    !< Add a 2-D variable to an existing NetCDF file with a mesh
  ...
  subroutine add_field_mesh_int_2D_c_notime( filename, ncid, var_name, long_name, units, precision)
    !< Add a 2-D variable to an existing NetCDF file with a mesh
  ...
  subroutine add_field_mesh_dp_2D_notime( filename, ncid, var_name, long_name, units, precision)
    !< Add a 2-D variable to an existing NetCDF file with a mesh
    ...
    ! Create variable
    call create_variable( filename, ncid, var_name, parse_netcdf_precision( precision), (/ id_dim_vi /), id_var)
  ...
  subroutine add_field_mesh_dp_2D_b_notime( filename, ncid, var_name, long_name, units, precision)
    !< Add a 2-D variable to an existing NetCDF file with a mesh
    ...
    ! Create variable
    call create_variable( filename, ncid, var_name, parse_netcdf_precision( precision), (/ id_dim_ti /), id_var)
  ...
  subroutine add_field_mesh_dp_2D_c_notime( filename, ncid, var_name, long_name, units, precision)
    !< Add a 2-D variable to an existing NetCDF file with a mesh
    ...
    ! Create variable
    call create_variable( filename, ncid, var_name, parse_netcdf_precision( precision), (/ id_dim_ei /), id_var)
  ...
  subroutine add_field_mesh_dp_2D_monthly_notime( filename, ncid, var_name, long_name, units, precision)
    !< Add a 2-D monthly variable to an existing NetCDF file with a mesh
    ...
    ! Create variable
    call create_variable( filename, ncid, var_name, parse_netcdf_precision( precision), (/ id_dim_vi, id_dim_month /), id_var)
  ...
  subroutine add_field_mesh_dp_3D_notime( filename, ncid, var_name, long_name, units, precision)
    !< Add a 3-D variable to an existing NetCDF file with a mesh
    ...
    ! Create variable
    call create_variable( filename, ncid, var_name, parse_netcdf_precision( precision), (/ id_dim_vi, id_dim_zeta /), id_var)
  ...
  subroutine add_field_mesh_dp_3D_b_notime( filename, ncid, var_name, long_name, units, precision)
    !< Add a 3-D variable to an existing NetCDF file with a mesh
    ...
    ! Create variable
    call create_variable( filename, ncid, var_name, parse_netcdf_precision( precision), (/ id_dim_ti, id_dim_zeta /), id_var)
  ...
  subroutine add_field_mesh_dp_3D_ocean_notime( filename, ncid, var_name, long_name, units, precision)
    !< Add a 3-D variable to an existing NetCDF file with a mesh
    ...
    ! Create variable
    call create_variable( filename, ncid, var_name, parse_netcdf_precision( precision), (/ id_dim_vi, id_dim_depth /), id_var)
