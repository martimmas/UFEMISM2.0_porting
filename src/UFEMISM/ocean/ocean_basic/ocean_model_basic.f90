module ocean_model_basic
  ...
  public :: atype_ocean_model, type_ocean_model_context_allocate, &
  ...
  type, abstract, extends(type_ocean_model_common) :: atype_ocean_model
    ...
    contains
      ...
      procedure(allocate_ocean_model_ifc),   deferred :: allocate_ocean_model
  ...
  type, extends(atype_model_context_allocate) :: type_ocean_model_context_allocate
  end type type_ocean_model_context_allocate
  ...
  abstract interface
    ...
    subroutine allocate_ocean_model_ifc( self, context)
      import atype_ocean_model, type_ocean_model_context_allocate
      class(atype_ocean_model),                        intent(inout) :: self
      type(type_ocean_model_context_allocate), target, intent(in   ) :: context
    end subroutine allocate_ocean_model_ifc
