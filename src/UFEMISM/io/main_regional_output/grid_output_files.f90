...
contains
  ...
  subroutine create_main_regional_output_file_grid_field( filename, ncid, choice_output_field)
    ...
    ! ===========================
      ...
      case ('resolution')
        call add_field_grid_dp_2D_notime( filename, ncid, 'resolution', precision = C%output_precision, long_name = 'Mesh resolution (distance to nearest neighbour)', units = 'm')
    ...
    ! ================================
      ...
      ! Initial ice-sheet geometry
      case ('Hi_init')
        call add_field_grid_dp_2D_notime( filename, ncid, 'Hi_init', precision = C%output_precision, long_name = 'Initial ice thickness', units = 'm')
      case ('Hb_init')
        call add_field_grid_dp_2D_notime( filename, ncid, 'Hb_init', precision = C%output_precision, long_name = 'Initial bedrock elevation', units = 'm w.r.t. PD sea level')
      case ('Hs_init')
        call add_field_grid_dp_2D_notime( filename, ncid, 'Hs_init', precision = C%output_precision, long_name = 'Initial surface elevation', units = 'm w.r.t. PD sea level')
      case ('SL_init')
        call add_field_grid_dp_2D_notime( filename, ncid, 'SL_init', precision = C%output_precision, long_name = 'Initial geoid elevation', units = 'm w.r.t. PD sea level')

      ! Present-day ice-sheet geometry
      case ('Hi_PD')
        call add_field_grid_dp_2D_notime( filename, ncid, 'Hi_PD', precision = C%output_precision, long_name = 'Present-day ice thickness', units = 'm')
      case ('Hb_PD')
        call add_field_grid_dp_2D_notime( filename, ncid, 'Hb_PD', precision = C%output_precision, long_name = 'Present-day bedrock elevation', units = 'm w.r.t. PD sea level')
      case ('Hs_PD')
        call add_field_grid_dp_2D_notime( filename, ncid, 'Hs_PD', precision = C%output_precision, long_name = 'Present-day surface elevation', units = 'm w.r.t. PD sea level')
      case ('SL_PD')
        call add_field_grid_dp_2D_notime( filename, ncid, 'SL_PD', precision = C%output_precision, long_name = 'Present-day geoid elevation', units = 'm w.r.t. PD sea level')

      ! GIA equilibrium ice-sheet geometry
      case ('Hi_GIAeq')
        call add_field_grid_dp_2D_notime( filename, ncid, 'Hi_GIAeq', precision = C%output_precision, long_name = 'GIA equilibrium ice thickness', units = 'm')
      case ('Hb_GIAeq')
        call add_field_grid_dp_2D_notime( filename, ncid, 'Hb_GIAeq', precision = C%output_precision, long_name = 'GIA equilibrium bedrock elevation', units = 'm w.r.t. PD sea level')
      case ('Hs_GIAeq')
        call add_field_grid_dp_2D_notime( filename, ncid, 'Hs_GIAeq', precision = C%output_precision, long_name = 'GIA equilibrium surface elevation', units = 'm w.r.t. PD sea level')
      case ('SL_GIAeq')
        call add_field_grid_dp_2D_notime( filename, ncid, 'SL_GIAeq', precision = C%output_precision, long_name = 'GIA equilibrium geoid elevation', units = 'm w.r.t. PD sea level')

    ! ===== Basic ice-sheet geometry =====
    ! ====================================

      case ('Hi')
        call add_field_grid_dp_2D( filename, ncid, 'Hi', precision = C%output_precision, long_name = 'Ice thickness', units = 'm')
      case ('Hb')
        call add_field_grid_dp_2D( filename, ncid, 'Hb', precision = C%output_precision, long_name = 'Bedrock elevation', units = 'm w.r.t. PD sea level')
      case ('Hs')
        call add_field_grid_dp_2D( filename, ncid, 'Hs', precision = C%output_precision, long_name = 'Surface elevation', units = 'm w.r.t. PD sea level')
      case ('Hib')
        call add_field_grid_dp_2D( filename, ncid, 'Hib', precision = C%output_precision, long_name = 'Ice base elevation', units = 'm w.r.t. PD sea level')
      case ('SL')
        call add_field_grid_dp_2D( filename, ncid, 'SL', precision = C%output_precision, long_name = 'Geoid elevation', units = 'm w.r.t. PD sea level')
      case ('TAF')
        call add_field_grid_dp_2D( filename, ncid, 'TAF', precision = C%output_precision, long_name = 'Thickness above floatation', units = 'm')
      case ('Hi_eff')
        call add_field_grid_dp_2D( filename, ncid, 'Hi_eff', precision = C%output_precision, long_name = 'Effective ice thickness', units = 'm')
      case ('Hs_slope')
        call add_field_grid_dp_2D( filename, ncid, 'Hs_slope', precision = C%output_precision, long_name = 'Absolute surface gradient', units = '-')
      case ('grounding_line')
        ! Do nothing; only written to mesh files
      case ('ice_margin')
        ! Do nothing; only written to mesh files
    ...
    ! =============================================
      ...
      case ('dHi')
        call add_field_grid_dp_2D( filename, ncid, 'dHi', precision = C%output_precision, long_name = 'Ice thickness difference w.r.t. reference', units = 'm')
      case ('dHb')
        call add_field_grid_dp_2D( filename, ncid, 'dHb', precision = C%output_precision, long_name = 'Bedrock elevation difference w.r.t. reference', units = 'm')
      case ('dHs')
        call add_field_grid_dp_2D( filename, ncid, 'dHs', precision = C%output_precision, long_name = 'Surface elevation difference w.r.t. reference', units = 'm')
      case ('dHib')
        call add_field_grid_dp_2D( filename, ncid, 'dHib', precision = C%output_precision, long_name = 'Ice base elevation difference w.r.t. reference', units = 'm')

    ! ===== Geometry rates of change =====
    ! ====================================

      case ('dHi_dt')
        call add_field_grid_dp_2D( filename, ncid, 'dHi_dt', precision = C%output_precision, long_name = 'Ice thickness rate of change', units = 'm yr^-1')
      case ('dHb_dt')
        call add_field_grid_dp_2D( filename, ncid, 'dHb_dt', precision = C%output_precision, long_name = 'Bedrock elevation rate of change', units = 'm yr^-1')
      case ('dHs_dt')
        call add_field_grid_dp_2D( filename, ncid, 'dHs_dt', precision = C%output_precision, long_name = 'Surface elevation rate of change', units = 'm yr^-1')
      case ('dHib_dt')
        call add_field_grid_dp_2D( filename, ncid, 'dHib_dt', precision = C%output_precision, long_name = 'Ice base elevation rate of change', units = 'm yr^-1')
      case ('dHi_dt_raw')
        call add_field_grid_dp_2D( filename, ncid, 'dHi_dt_raw', precision = C%output_precision, long_name = 'Ice thickness rate of change before any modifications', units = 'm yr^-1')
      case ('dHi_dt_residual')
        call add_field_grid_dp_2D( filename, ncid, 'dHi_dt_residual', precision = C%output_precision, long_name = 'Residual ice thickness rate of change during model calibration', units = 'm yr^-1')

    ! ===== Target quantities =====
    ! =============================

      case ('dHi_dt_target')
        call add_field_grid_dp_2D( filename, ncid, 'dHi_dt_target', precision = C%output_precision, long_name = 'Target ice thickness rate of change during model calibration', units = 'm yr^-1')
      case ('uabs_surf_target')
        call add_field_grid_dp_2D( filename, ncid, 'uabs_surf_target', precision = C%output_precision, long_name = 'Target ice surface speed during model calibration', units = 'm yr^-1')
    ...
    ! =================
      ...
      case ('mask_ROI')
        ...
        call add_field_grid_dp_2D( filename, ncid, 'mask_ROI', precision = C%output_precision, long_name = 'ROI mask', units = '')
    ...
    ! ===================================
      ...
      case ('Ti')
        call add_field_grid_dp_3D( filename, ncid, 'Ti', precision = C%output_precision, long_name = 'Englacial temperature', units = 'K')
      case ('Ti_pmp')
        call add_field_grid_dp_3D( filename, ncid, 'Ti_pmp', precision = C%output_precision, long_name = 'Pressure melting point temperature', units = 'K')
      case ('Ti_hom')
        call add_field_grid_dp_2D( filename, ncid, 'Ti_hom', precision = C%output_precision, long_name = 'Temperature at base w.r.t. pressure melting point', units = 'K')
      case ('Cpi')
        call add_field_grid_dp_3D( filename, ncid, 'Cpi', precision = C%output_precision, long_name = 'Specific heat capacity', units = 'J kg^-1 K^-1')
      case ('Ki')
        call add_field_grid_dp_3D( filename, ncid, 'Ki', precision = C%output_precision, long_name = 'Thermal conductivity', units = 'J m^-1 K^-1 yr^-1')
      case ('internal_heating')
        call add_field_grid_dp_3D( filename, ncid, 'internal_heating', precision = C%output_precision, long_name = 'Internal heating', units = '?')
      case ('frictional_heating')
        call add_field_grid_dp_2D( filename, ncid, 'frictional_heating', precision = C%output_precision, long_name = 'Frictional heating', units = '?')
      case ('A_flow')
        call add_field_grid_dp_3D( filename, ncid, 'A_flow', precision = C%output_precision, long_name = 'Glens flow law factor', units = 'Pa^-3 y^-1')
    ...
    ! ======================
      ...
      ! 3-D
      case ('u_3D')
        call add_field_grid_dp_3D( filename, ncid, 'u_3D', precision = C%output_precision, long_name = '3-D ice velocity in the x-direction', units = 'm yr^-1')
      case ('v_3D')
        call add_field_grid_dp_3D( filename, ncid, 'v_3D', precision = C%output_precision, long_name = '3-D ice velocity in the y-direction', units = 'm yr^-1')
      case ('u_3D_b')
        ! notE: mapping from mesh triangles to square grid is not (yet) available!
      case ('v_3D_b')
        ! notE: mapping from mesh triangles to square grid is not (yet) available!
      case ('w_3D')
        call add_field_grid_dp_3D( filename, ncid, 'w_3D', precision = C%output_precision, long_name = '3-D ice velocity in the z-direction', units = 'm yr^-1')

      ! Vertically integrated
      case ('u_vav')
        call add_field_grid_dp_2D( filename, ncid, 'u_vav', precision = C%output_precision, long_name = 'Vertically averaged ice velocity in the x-direction', units = 'm yr^-1')
      case ('v_vav')
        call add_field_grid_dp_2D( filename, ncid, 'v_vav', precision = C%output_precision, long_name = 'Vertically averaged ice velocity in the y-direction', units = 'm yr^-1')
      case ('u_vav_b')
        ! notE: mapping from mesh triangles to square grid is not (yet) available!
      case ('v_vav_b')
        ! notE: mapping from mesh triangles to square grid is not (yet) available!
      case ('uabs_vav')
        call add_field_grid_dp_2D( filename, ncid, 'uabs_vav', precision = C%output_precision, long_name = 'Vertically averaged absolute ice velocity', units = 'm yr^-1')
      case ('uabs_vav_b')
        ! notE: mapping from mesh triangles to square grid is not (yet) available!

      ! Surface
      case ('u_surf')
        call add_field_grid_dp_2D( filename, ncid, 'u_surf', precision = C%output_precision, long_name = 'Surface ice velocity in the x-direction', units = 'm yr^-1')
      case ('v_surf')
        call add_field_grid_dp_2D( filename, ncid, 'v_surf', precision = C%output_precision, long_name = 'Surface ice velocity in the y-direction', units = 'm yr^-1')
      case ('u_surf_b')
        ! notE: mapping from mesh triangles to square grid is not (yet) available!
      case ('v_surf_b')
        ! notE: mapping from mesh triangles to square grid is not (yet) available!
      case ('w_surf')
        call add_field_grid_dp_2D( filename, ncid, 'w_surf', precision = C%output_precision, long_name = 'Surface ice velocity in the z-direction', units = 'm yr^-1')
      case ('uabs_surf')
        call add_field_grid_dp_2D( filename, ncid, 'uabs_surf', precision = C%output_precision, long_name = 'Absolute surface ice velocity', units = 'm yr^-1')
      case ('uabs_surf_b')
        ! notE: mapping from mesh triangles to square grid is not (yet) available!

      ! Base
      case ('u_base')
        call add_field_grid_dp_2D( filename, ncid, 'u_base', precision = C%output_precision, long_name = 'Basal ice velocity in the x-direction', units = 'm yr^-1')
      case ('v_base')
        call add_field_grid_dp_2D( filename, ncid, 'v_base', precision = C%output_precision, long_name = 'Basal ice velocity in the y-direction', units = 'm yr^-1')
      case ('u_base_b')
        ! notE: mapping from mesh triangles to square grid is not (yet) available!
      case ('v_base_b')
        ! notE: mapping from mesh triangles to square grid is not (yet) available!
      case ('w_base')
        call add_field_grid_dp_2D( filename, ncid, 'w_base', precision = C%output_precision, long_name = 'Basal ice velocity in the z-direction', units = 'm yr^-1')
      case ('uabs_base')
        call add_field_grid_dp_2D( filename, ncid, 'uabs_base', precision = C%output_precision, long_name = 'Absolute basal ice velocity', units = 'm yr^-1')
      case ('uabs_base_b')
        ! notE: mapping from mesh triangles to square grid is not (yet) available!
    ...
    ! ====================
      ...
      case ('du_dx_3D')
        call add_field_grid_dp_3D( filename, ncid, 'du_dx_3D', precision = C%output_precision, long_name = '3-D xx strain rate', units = 'yr^-1')
      case ('du_dy_3D')
        call add_field_grid_dp_3D( filename, ncid, 'du_dy_3D', precision = C%output_precision, long_name = '3-D xy strain rate', units = 'yr^-1')
      case ('du_dz_3D')
        call add_field_grid_dp_3D( filename, ncid, 'du_dz_3D', precision = C%output_precision, long_name = '3-D xz strain rate', units = 'yr^-1')
      case ('dv_dx_3D')
        call add_field_grid_dp_3D( filename, ncid, 'dv_dx_3D', precision = C%output_precision, long_name = '3-D yx strain rate', units = 'yr^-1')
      case ('dv_dy_3D')
        call add_field_grid_dp_3D( filename, ncid, 'dv_dy_3D', precision = C%output_precision, long_name = '3-D yy strain rate', units = 'yr^-1')
      case ('dv_dz_3D')
        call add_field_grid_dp_3D( filename, ncid, 'dv_dz_3D', precision = C%output_precision, long_name = '3-D yz strain rate', units = 'yr^-1')
      case ('dw_dx_3D')
        call add_field_grid_dp_3D( filename, ncid, 'dw_dx_3D', precision = C%output_precision, long_name = '3-D zx strain rate', units = 'yr^-1')
      case ('dw_dy_3D')
        call add_field_grid_dp_3D( filename, ncid, 'dw_dy_3D', precision = C%output_precision, long_name = '3-D zy strain rate', units = 'yr^-1')
      case ('dw_dz_3D')
        call add_field_grid_dp_3D( filename, ncid, 'dw_dz_3D', precision = C%output_precision, long_name = '3-D zz strain rate', units = 'yr^-1')

    ! == Ice flow regime ==
    ! =====================

      case ('divQ')
        call add_field_grid_dp_2D( filename, ncid, 'divQ', precision = C%output_precision, long_name = 'Horizontal ice flux divergence', units = 'm yr^-1')
      case ('R_shear')
        call add_field_grid_dp_2D( filename, ncid, 'R_shear', precision = C%output_precision, long_name = 'Slide/shear ratio', units = '0-1')

    ! == Ice P/C time stepping ==
    ! ===========================

      case ('pc_truncation_error')
        call add_field_grid_dp_2D( filename, ncid, 'pc_truncation_error', precision = C%output_precision, long_name = 'Ice P/C truncation error tau', units = 'm')
      case ('pc_untolerated_events')
        ! DENK DROM : not gridable
    ...
    ! =====================
      ...
      case ('pore_water_pressure')
        call add_field_grid_dp_2D( filename, ncid, 'pore_water_pressure', precision = C%output_precision, long_name = 'Till pore water pressure', units = 'Pa')
      case ('overburden_pressure')
        call add_field_grid_dp_2D( filename, ncid, 'overburden_pressure', precision = C%output_precision, long_name = 'Ice overburden pressure', units = 'Pa')
      case ('effective_pressure')
        call add_field_grid_dp_2D( filename, ncid, 'effective_pressure', precision = C%output_precision, long_name = 'Effective basal pressure', units = 'Pa')
      case ('pore_water_likelihood')
        call add_field_grid_dp_2D( filename, ncid, 'pore_water_likelihood', precision = C%output_precision, long_name = 'Till pore water likelihood', units = '0-1')
      case ('pore_water_fraction')
        call add_field_grid_dp_2D( filename, ncid, 'pore_water_fraction', precision = C%output_precision, long_name = 'Fraction of overburden pressure reduced by pore water', units = '0-1')
    ...
    ! ===================
      ...
      ! Sliding law coefficients
      case ('till_friction_angle')
        call add_field_grid_dp_2D( filename, ncid, 'till_friction_angle', precision = C%output_precision, long_name = 'Till friction angle', units = 'degrees')
      case ('alpha_sq')
        call add_field_grid_dp_2D( filename, ncid, 'alpha_sq', precision = C%output_precision, long_name = 'Coulomb-law friction coefficientn', units = 'dimensionless')
      case ('beta_sq')
        call add_field_grid_dp_2D( filename, ncid, 'beta_sq', precision = C%output_precision, long_name = 'Power-law friction coefficient', units = 'Pa m^−1/m yr^1/m')

        ! Basal friction and shear stress
      case ('till_yield_stress')
        call add_field_grid_dp_2D( filename, ncid, 'till_yield_stress', precision = C%output_precision, long_name = 'Till yield stress', units = 'Pa')
      case ('basal_friction_coefficient')
        call add_field_grid_dp_2D( filename, ncid, 'basal_friction_coefficient', precision = C%output_precision, long_name = 'Basal friction coefficient', units = 'Pa yr m^-1')
      case ('basal_shear_stress')
        call add_field_grid_dp_2D( filename, ncid, 'basal_shear_stress', precision = C%output_precision, long_name = 'Basal shear stress', units = 'Pa')
    ...
    ! =====================
      ...
      case ('geothermal_heat_flux')
        call add_field_grid_dp_2D( filename, ncid, 'geothermal_heat_flux', precision = C%output_precision, long_name = 'Geothermal heat flux', units = 'J m^-2 yr^-1')
    ...
    ! =============
      ...
      ! Main climate variables
      case ('T2m')
        call add_field_grid_dp_2D_monthly( filename, ncid, 'T2m', precision = C%output_precision, long_name = 'Monthly mean 2-m air temperature', units = 'K')
      case ('Precip')
        call add_field_grid_dp_2D_monthly( filename, ncid, 'Precip', precision = C%output_precision, long_name = 'Monthly total precipitation', units = 'm.w.e.')
      CASE ('Q_TOA')
        CALL add_field_grid_dp_2D_monthly( filename, ncid, 'Q_TOA', precision = C%output_precision, long_name = 'Monthly insolation at the top of the atmosphere', units = 'W m^-2')
    ...
    ! ==========================
      ...
      ! Main ocean variables
      case ('T_ocean')
        call add_field_grid_dp_3D_ocean( filename, ncid, 'T_ocean', precision = C%output_precision, long_name = 'Ocean temperature', units = 'deg C')
      case ('S_ocean')
        call add_field_grid_dp_3D_ocean( filename, ncid, 'S_ocean', precision = C%output_precision, long_name = 'Ocean salinity', units = 'psu')
      case ('T_draft')
        call add_field_grid_dp_2D( filename, ncid, 'T_draft', precision = C%output_precision, long_name = 'Ocean temperature at ice draft', units = 'deg C')
      case ('T_freezing_point')
        call add_field_grid_dp_2D( filename, ncid, 'T_freezing_point', precision = C%output_precision, long_name = 'Ocean freezing temperature at ice draft', units = 'deg C')
    ...
    ! ==========================
      ...
      ! Main SMB variables
      case ('SMB')
        call add_field_grid_dp_2D( filename, ncid, 'SMB', precision = C%output_precision, long_name = 'Surface mass balance', units = 'm yr^-1')
      case ('Albedo')
        call add_field_grid_dp_2D_monthly( filename, ncid, 'Albedo', precision = C%output_precision, long_name = 'Surface albedo', units = '0-1')
      case ('FirnDepth')
        call add_field_grid_dp_2D_monthly( filename, ncid, 'FirnDepth', precision = C%output_precision, long_name = 'Monthly firn layer depth', units = 'm')
      case ('MeltPreviousYear')
        call add_field_grid_dp_2D_monthly( filename, ncid, 'MeltPreviousYear', precision = C%output_precision, long_name = 'Total ice melt from previous year', units = 'm')
    ...
    ! ========================
      ...
      ! Main BMB variables
      case ('BMB')
        call add_field_grid_dp_2D( filename, ncid, 'BMB', precision = C%output_precision, long_name = 'Basal mass balance', units = 'm yr^-1')
      case ('BMB_inv')
        call add_field_grid_dp_2D( filename, ncid, 'BMB_inv', precision = C%output_precision, long_name = 'Basal mass balance - inverted', units = 'm yr^-1')
      case ('BMB_transition_phase')
        call add_field_grid_dp_2D( filename, ncid, 'BMB_transition_phase', precision = C%output_precision, long_name = 'Basal mass balance - transition phase', units = 'm yr^-1')
      case ('BMB_modelled')
        call add_field_grid_dp_2D( filename, ncid, 'BMB_modelled', precision = C%output_precision, long_name = 'Basal mass balance - modelled', units = 'm yr^-1')
    ...
    ! ============
      ...
      ! Main laddie variables
      case ('H_lad')
        call add_field_grid_dp_2D( filename, ncid, 'H_lad', precision = C%output_precision, long_name = 'Laddie layer thickness', units = 'm')
      case ('U_lad')
        call add_field_grid_dp_2D( filename, ncid, 'U_lad', precision = C%output_precision, long_name = 'Laddie U velocity', units = 'm s^-1')
      case ('V_lad')
        call add_field_grid_dp_2D( filename, ncid, 'V_lad', precision = C%output_precision, long_name = 'Laddie V velocity', units = 'm s^-1')
      case ('T_lad')
        call add_field_grid_dp_2D( filename, ncid, 'T_lad', precision = C%output_precision, long_name = 'Laddie temperature', units = 'deg C')
      case ('S_lad')
        call add_field_grid_dp_2D( filename, ncid, 'S_lad', precision = C%output_precision, long_name = 'Laddie salinity', units = 'PSU')

      ! Useful laddie fields
      case ('drho_amb')
        call add_field_grid_dp_2D( filename, ncid, 'drho_amb', precision = C%output_precision, long_name = 'Depth integrated buoyancy', units = 'kg m^-2')
      case ('drho_base')
        call add_field_grid_dp_2D( filename, ncid, 'drho_base', precision = C%output_precision, long_name = 'Depth integrated buoyancy', units = 'kg m^-2')
      case ('entr')
        call add_field_grid_dp_2D( filename, ncid, 'entr', precision = C%output_precision, long_name = 'Entrainment rate', units = 'm s^-1')
      case ('entr_dmin')
        call add_field_grid_dp_2D( filename, ncid, 'entr_dmin', precision = C%output_precision, long_name = 'Entrainment rate for Dmin', units = 'm s^-1')
      case ('SGD')
        call add_field_grid_dp_2D( filename, ncid, 'SGD', precision = C%output_precision, long_name = 'Subglacial discharge rate', units = 'm s^-1')
      case ('melt')
        call add_field_grid_dp_2D( filename, ncid, 'melt', precision = C%output_precision, long_name = 'melt rate', units = 'm s^-1')
      case ('divQH')
        call add_field_grid_dp_2D( filename, ncid, 'divQH', precision = C%output_precision, long_name = 'Thickness divergence', units = 'm s^-1')
      case ('divQT')
        call add_field_grid_dp_2D( filename, ncid, 'divQT', precision = C%output_precision, long_name = 'Heat divergence', units = 'degC m s^-1')
      case ('divQS')
        call add_field_grid_dp_2D( filename, ncid, 'divQS', precision = C%output_precision, long_name = 'Salt divergence', units = 'PSU m s^-1')
      case ('diffT')
        call add_field_grid_dp_2D( filename, ncid, 'diffT', precision = C%output_precision, long_name = 'Heat diffusion', units = 'degC m s^-1')
      case ('diffS')
        call add_field_grid_dp_2D( filename, ncid, 'diffS', precision = C%output_precision, long_name = 'Salt diffusion', units = 'PSU m s^-1')
      case ('viscU')
        ! not implemented
      case ('viscV')
        ! not implemented
      case ('T_base')
        call add_field_grid_dp_2D( filename, ncid, 'T_base', precision = C%output_precision, long_name = 'Temperature at ice/ocean interface', units = 'deg C')
      case ('T_amb')
        call add_field_grid_dp_2D( filename, ncid, 'T_amb', precision = C%output_precision, long_name = 'Temperature at interface with ambient ocean', units = 'deg C')
      case ('u_star')
        call add_field_grid_dp_2D( filename, ncid, 'u_star', precision = C%output_precision, long_name = 'Friction velocity', units = 'm s^-1')
      case ('gamma_T')
        call add_field_grid_dp_2D( filename, ncid, 'gamma_T', precision = C%output_precision, long_name = 'Heat exchange coefficient', units = 'm s^-1')
      case ('divQU')
        ! not implemented
      case ('divQV')
        ! not implemented
    ...
    ! ==========================
      ...
      ! Main LMB variables
      case ('LMB')
        call add_field_grid_dp_2D( filename, ncid, 'LMB', precision = C%output_precision, long_name = 'Lateral mass balance', units = 'm yr^-1')
    ...
    ! =============================
      ...
      ! Main AMB variables
      case ('AMB')
        call add_field_grid_dp_2D( filename, ncid, 'AMB', precision = C%output_precision, long_name = 'Artificial mass balance', units = 'm yr^-1')
    ...
    ! ==================================
      ...
      ! Main GIA variables
      case ('dHb_next')
        call add_field_grid_dp_2D( filename, ncid, 'dHb_next', precision = C%output_precision, long_name = 'Bedrock elevation difference from ELRA', units = 'm')

    ! == Tracer tracking ==
    ! =====================

      case ('age')
        call add_field_grid_dp_3D( filename, ncid, 'age', precision = C%output_precision, long_name = 'Age of ice', units = 'yr')
