module DIVA_solver_infinite_slab
  ...
  public :: solve_DIVA_infinite_slab, calc_vertical_shear_strain_rates, calc_effective_viscosity, &
...
contains
  ...
  subroutine solve_DIVA_infinite_slab( mesh, ice, bed_roughness, DIVA, n_visc_its, n_Axb_its, &
    ...
    viscosity_iteration: do while (.not. has_converged)
      ...
      call calc_horizontal_strain_rates( mesh, DIVA%u_vav_b, DIVA%v_vav_b, &
...
end module DIVA_solver_infinite_slab
