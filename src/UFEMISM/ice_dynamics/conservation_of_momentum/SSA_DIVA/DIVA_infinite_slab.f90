module DIVA_infinite_slab
  ...
  public :: allocate_DIVA_solver, initialise_DIVA_solver_infinite_slab, solve_DIVA_infinite_slab, &
    ...
    calc_vertical_shear_strain_rates, calc_effective_viscosity, &
    calc_F_integrals, calc_effective_basal_friction_coefficient, calc_basal_shear_stress, &
    calc_basal_velocities, calc_3D_velocities

contains

  ! == Main routines

  subroutine initialise_DIVA_solver_infinite_slab( mesh, DIVA, region_name)
    ...
    ! Local variables:
    character(len=1024), parameter :: routine_name = 'initialise_DIVA_solver_infinite_slab'
  ...
  end subroutine initialise_DIVA_solver_infinite_slab
  ...
  end subroutine solve_DIVA_infinite_slab

  subroutine remap_DIVA_solver_infinite_slab( mesh_old, mesh_new, DIVA)
    ...
    ! Local variables:
    character(len=1024), parameter        :: routine_name = 'remap_DIVA_solver_infinite_slab'
  ...
  end subroutine remap_DIVA_solver_infinite_slab
  ...
  subroutine initialise_DIVA_velocities_from_file_infinite_slab( mesh, DIVA, region_name)
    ...
    ! Local variables:
    character(len=1024), parameter :: routine_name = 'initialise_DIVA_velocities_from_file_infinite_slab'
    real(dp)                       :: dummy1
  ...
  end subroutine initialise_DIVA_velocities_from_file_infinite_slab

  subroutine write_to_restart_file_DIVA_infinite_slab( mesh, DIVA, time)
    ...
    ! Local variables:
    character(len=1024), parameter :: routine_name = 'write_to_restart_file_DIVA_infinite_slab'
    integer                        :: ncid
  ...
  end subroutine write_to_restart_file_DIVA_infinite_slab

  subroutine create_restart_file_DIVA_infinite_slab( mesh, DIVA)
    ...
    ! Local variables:
    character(len=1024), parameter :: routine_name = 'create_restart_file_DIVA_infinite_slab'
  ...
  end subroutine create_restart_file_DIVA_infinite_slab

end module DIVA_infinite_slab
